#ifndef INVALID_EDGE_PREPROCESSING_2_MATHEUS_MODEL_4_CPLEX_HPP_
#define INVALID_EDGE_PREPROCESSING_2_MATHEUS_MODEL_4_CPLEX_HPP_
    ...
    namespace cplex {
      namespace matheus_model_4 {
        class Invalid_edge_preprocessing_2 : public Preprocessing {
          public:
            explicit Invalid_edge_preprocessing_2 (Matheus_model_4& matheus_model_4);
            void add ();
        };
      }
    }
