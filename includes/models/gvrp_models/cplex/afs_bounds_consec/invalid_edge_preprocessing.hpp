#ifndef INVALID_EDGE_PREPROCESSING_AFS_BOUNDS_CONSEC_CPLEX_HPP_
#define INVALID_EDGE_PREPROCESSING_AFS_BOUNDS_CONSEC_CPLEX_HPP_
    ...
    namespace cplex {
      namespace afs_bounds_consec {
        class Invalid_edge_preprocessing : public Preprocessing {
          public:
            explicit Invalid_edge_preprocessing (Afs_bounds_consec& afs_bounds_consec);
            void add ();
        };
      }
    }
